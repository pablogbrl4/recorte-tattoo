$(document).ready(function () {
     ...
     function FileUploader (fileUpload) {
        ...
        var pasta = $("input[type=hidden][id=pasta]").val(); // 
        var subpasta = $("input[type=hidden][id=subpasta]").val();
        var outrapasta = $("input[type=hidden][id=outrapasta]").val();
        var id = $("input[type=hidden][id=id]").val();

        //var nomeFoto = document.getElementById('ImageName').value
                          
        var caminho = "\\Images\\" + pasta + "\\" + subpasta + "\\";

         if (outrapasta != undefined ) {
             caminho += outrapasta + "\\"
         }
        ...
        data.append("UploadLocation", caminho); ///location
        data.append("FileInitials", id ); ///create files name with start
